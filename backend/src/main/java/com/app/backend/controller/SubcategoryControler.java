...
public class SubcategoryControler{
    ...
    public ResponseEntity<Subcategory> deleteSubcategory(@PathVariable Long id) {
        subcategoryService.delete(id);
        return ResponseEntity.ok().body(new MessagerResponse("Subcategoría eliminada exitosamente"));
    }
}
